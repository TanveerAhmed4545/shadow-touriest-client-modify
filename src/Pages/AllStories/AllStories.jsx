    ...
    return (
        <div className="font-sans w-full overflow-x-hidden bg-brand-light pb-24">
            ...
            <div 
              ...
              style={{
                backgroundImage: "url('https://images.unsplash.com/photo-1516483638261-f40af5a5fac6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80')"
              }}
            >
              ...
              <div className="relative z-10 text-center text-white mt-16 px-4">
                <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6">Travel Stories</h1>
                <div className="flex items-center justify-center space-x-3 text-lg font-medium">
                  ...
                  <span className="text-brand-secondary">Stories</span>
                </div>
              </div>
            </div>
            ...
            <div className="container mx-auto px-5 lg:px-20 -mt-20 relative z-20">
              ...
              {stories.length === 0 && (
                <div className="bg-white p-10 rounded-[30px] text-center border border-gray-100 shadow-sm w-full">
                    <p className="text-gray-500 text-lg">No stories available at the moment. Check back soon!</p>
                </div>
              )}
            </div>
